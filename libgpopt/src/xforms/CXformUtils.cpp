       ...
       )
{
       ...
       // This xform utils converts an exists query to scalar subquery with limit.
       // For example, consider the input query to be
       // select * from customer where exists (select * from product);
       // To ensure correctness, we need to make sure that there exists atleast one tuple in
       // subquery (select * from product). To achieve this, we convert the above query as follows
       // select * from customer where 0 < (select 1 as DUMMY_CONSTANT_ONE (select * from product limit 1));
       // Here, the sole purpose of the DUMMY_CONSTANT_ONE is to validate that there is a single
       // tuple in the subquery
       ...
       //    |--CLogicalGet "customer" ("customer"), Columns: ["cn" (13), "cname" (14), "cloc" (15), "ctid" (16), "xmin" (17), "cmin" (18), "xmax" (19), "cmax" (20), "tableoid" (21), "gp_segment_id" (22)] Key sets: {[0], [3,9]}
       //    +--CScalarCmp (>)
       //       |--CScalarSubquery["ColRef_0035" (35)] generated by Exist SQ
       //          |  +--CLogicalProject
       ...
       // create a int8 DUMMY_CONSTANT_ONE
