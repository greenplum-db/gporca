...
namespace gpopt
{
	...
	class CPhysicalFilter : public CPhysical
	{
		...
		protected:
			// partition propagation request generated by a filter
			class CPartPropReq : public CRefCount
			{
				private:
					...
					// id of outer child
					ULONG m_ulOuterChildId;

					// id of scalar child
					ULONG m_ulScalarChildId;
				...
				public:
					...
					CPartPropReq
						...
						ULONG ulOuterChildId,
						ULONG ulScalarChildId
						)
						:
						m_pppsRequired(pppsRequired),
						m_ulOuterChildId(ulOuterChildId),
						m_ulScalarChildId(ulScalarChildId)
					{
					...
					// outer child id
					ULONG UlOuterChildId() const
					{
						return m_ulOuterChildId;
					}

					// scalar child id
					ULONG UlScalarChildId() const
					{
						return m_ulScalarChildId;
					}
		...
		public:
			...
			// ctor
			explicit
			CPhysicalFilter(IMemoryPool *pmp);
			...
			virtual
			CPartitionPropagationSpec *PppsRequiredFilter
				(
				IMemoryPool *pmp,
				CExpressionHandle &exprhdl,
				CPartitionPropagationSpec *pppsRequired,
